...
public class QuestListener implements Listener {
	...
	public void onObjectiveProgress(ObjectiveProgressEvent e){
		...
		DebugUtils.sendDebugMessage("Player " + e.getPlayer().getHangoutPlayer().getName() + " has progressed quest " + e.getObjective().getParent().getDisplayName());
	...
	public void onObjectiveComplete(ObjectiveCompleteEvent e){
		...
		DebugUtils.sendDebugMessage("Player " + e.getPlayer().getHangoutPlayer().getName() + " has completed objective " + e.getObjective().getDisplayName());
	...
	public void onQuestComplete(QuestCompleteEvent e){
		...
		DebugUtils.sendDebugMessage("Player " + e.getPlayer().getHangoutPlayer().getName() + " has completed quest " + e.getQuest().getDisplayName());
	}
}
